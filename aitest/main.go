...
func main() {
	...
	// Use the exact input from your Python example
	/*testInput := []float32{
		16,           // num_of_cpu
		14,           // cpu_usage (87.5% utilization)
		28000000000,  // memory_allocated (28 GB)
		95000000000,  // memory_allocations
		68.5,         // memory_usage_percent
		500000000000, // disk_usage_total (500 GB)
		425000000000, // disk_usage_used (425 GB - 85% full)
		75000000000,  // disk_usage_free (75 GB)
		16000000000,  // swap_total (16 GB)
		8000000000,   // swap_free (8 GB)
		8000000000,   // swap_used (8 GB - swap being used!)
		24000000000,  // cache_memory
		32000000,     // buffer_memory
		45,           // ssh_connections
		1250,         // http_connections
		3800,         // https_connections
	}

	*/
	testInput := []float32{
		8,            // num_of_cpu
		2,            // cpu_usage (25% utilization)
		8000000000,   // memory_allocated (8 GB)
		25000000000,  // memory_allocations
		18.2,         // memory_usage_percent
		250000000000, // disk_usage_total (250 GB)
		50000000000,  // disk_usage_used (50 GB - 20% full)
		200000000000, // disk_usage_free (200 GB)
		4000000000,   // swap_total (4 GB)
		4000000000,   // swap_free (4 GB - no swap used)
		0,            // swap_used
		12000000000,  // cache_memory
		8000000,      // buffer_memory
		5,            // ssh_connections
		120,          // http_connections
		450,          // https_connections
	}
